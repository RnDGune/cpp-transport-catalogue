...
namespace transport_catalogue
{
	...
	const Route* TransportCatalogue::GetRouteByName(const std::string_view bus_name) const
	{
	...
	const std::unordered_map<std::pair<const Stop*, const Stop*>, size_t, PairPointersHasher>& TransportCatalogue::GetAllDistances() const
	{
